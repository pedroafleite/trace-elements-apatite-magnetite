Part 1: Data Exploration of Trace Elements in Apatite
================
...
As you can probably sense by now, examining all those boxplots can be
exaustive and somewhat inconclusive. A better way of evaluating that
data would be to apply more advanced statistical techniques, generally
referred to as **multivariate discriminant analysis**, in which we
reduce the dimensionallity of the data. Each trace element,
e.g. variable, opens up a new mathematical dimension onto which the
data may pivot itself. Understanding the real geometrical dimension of
this data may require statistical tools that are known in the machine
learning community, such as Principal Component Analysis (PCA).

For PCA and other multivariate discriminant analysis, see
[Part 2](https://github.com/pedroafleite/trace-elements-apatite-magnetite/blob/main/part2_apatite_discriminant.md).
